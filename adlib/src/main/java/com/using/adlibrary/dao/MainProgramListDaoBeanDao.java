...
/*     */ 
/*     */ 
/*     */ public class MainProgramListDaoBeanDao
/*     */   extends AbstractDao<MainProgramListDaoBean, Long>
/*     */ {
/*     */   public static final String TABLENAME = "MAIN_PROGRAM_LIST_DAO_BEAN";
/*     */   private DaoSession daoSession;
/*     */   private Query<MainProgramListDaoBean> rootListDaoBean_MainProgramListQuery;
/*     */   
...
/*     */ 
/*     */   
/*     */   public MainProgramListDaoBeanDao(DaoConfig config) {
/*  43 */     super(config);
/*     */   }
/*     */   
/*     */   public MainProgramListDaoBeanDao(DaoConfig config, DaoSession daoSession) {
...
/*  54 */     db.execSQL("CREATE TABLE " + constraint + "\"MAIN_PROGRAM_LIST_DAO_BEAN\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"PLAY_LIST_ID\" INTEGER NOT NULL ,\"LINK_ID\" INTEGER NOT NULL ,\"PLAY_LIST_NAME\" TEXT,\"RESOLUTION\" TEXT,\"HORORVER\" TEXT);");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAIN_PROGRAM_LIST_DAO_BEAN\"";
/*  66 */     db.execSQL(sql);
/*     */   }
/*     */ 
/*     */   
/*     */   protected final void bindValues(DatabaseStatement stmt, MainProgramListDaoBean entity) {
...
/*     */ 
/*     */   
/*     */   protected final void bindValues(SQLiteStatement stmt, MainProgramListDaoBean entity) {
...
/*     */ 
/*     */   
/*     */   protected final void attachEntity(MainProgramListDaoBean entity) {
...
/*     */ 
/*     */   
/*     */   public MainProgramListDaoBean readEntity(Cursor cursor, int offset) {
/* 142 */     MainProgramListDaoBean entity = new MainProgramListDaoBean(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)), cursor.getLong(offset + 1), cursor.getLong(offset + 2), cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
/*     */     
/* 144 */     return entity;
/*     */   }
/*     */ 
/*     */   
/*     */   public void readEntity(Cursor cursor, MainProgramListDaoBean entity, int offset) {
...
/*     */ 
/*     */   
/*     */   protected final Long updateKeyAfterInsert(MainProgramListDaoBean entity, long rowId) {
/* 159 */     entity.setId(Long.valueOf(rowId));
/* 160 */     return Long.valueOf(rowId);
/*     */   }
/*     */ 
/*     */   
/*     */   public Long getKey(MainProgramListDaoBean entity) {
/* 165 */     if (entity != null) {
...
/*     */ 
/*     */   
/*     */   public boolean hasKey(MainProgramListDaoBean entity) {
...
/*     */ 
/*     */   
/*     */   public List<MainProgramListDaoBean> _queryRootListDaoBean_MainProgramList(long link_id) {
/* 184 */     synchronized (this) {
/* 185 */       if (this.rootListDaoBean_MainProgramListQuery == null) {
/* 186 */         QueryBuilder<MainProgramListDaoBean> queryBuilder = queryBuilder();
/* 187 */         queryBuilder.where(Properties.Link_id.eq(null), new org.greenrobot.greendao.query.WhereCondition[0]);
/* 188 */         this.rootListDaoBean_MainProgramListQuery = queryBuilder.build();
/*     */       } 
/*     */     } 
/* 191 */     Query<MainProgramListDaoBean> query = this.rootListDaoBean_MainProgramListQuery.forCurrentThread();
...
/* Location:              D:\androidstudio\workspace\TestProjects\reverseAPK\adlibrary-release\classes.jar!\co\\using\adlibrary\dao\MainProgramListDaoBeanDao.class
