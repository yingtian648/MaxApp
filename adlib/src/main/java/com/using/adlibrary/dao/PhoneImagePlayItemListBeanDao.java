...
/*     */ 
/*     */ 
/*     */ public class PhoneImagePlayItemListBeanDao
/*     */   extends AbstractDao<PhoneImagePlayItemListBean, Long>
/*     */ {
/*     */   public static final String TABLENAME = "PHONE_IMAGE_PLAY_ITEM_LIST_BEAN";
/*     */   private Query<PhoneImagePlayItemListBean> phonePlayAreaListBean_ImagePlayItemListQuery;
/*     */   
...
/*  38 */     public static final Property Running_time = new Property(8, int.class, "running_time", false, "RUNNING_TIME");
/*  39 */     public static final Property File_md5 = new Property(9, String.class, "file_md5", false, "FILE_MD5");
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public PhoneImagePlayItemListBeanDao(DaoConfig config) {
/*  45 */     super(config);
/*     */   }
/*     */   
/*     */   public PhoneImagePlayItemListBeanDao(DaoConfig config, DaoSession daoSession) {
...
/*  55 */     db.execSQL("CREATE TABLE " + constraint + "\"PHONE_IMAGE_PLAY_ITEM_LIST_BEAN\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"ITEM_ID\" INTEGER NOT NULL ,\"LINK_ID\" INTEGER NOT NULL ,\"PLAY_ITEM_NAME\" TEXT,\"PLAY_ITEM_TYPE\" TEXT,\"SIZE\" INTEGER NOT NULL ,\"CHECKSUM\" TEXT,\"FILE_NAME\" TEXT,\"RUNNING_TIME\" INTEGER NOT NULL ,\"FILE_MD5\" TEXT);");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  70 */     String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PHONE_IMAGE_PLAY_ITEM_LIST_BEAN\"";
/*  71 */     db.execSQL(sql);
/*     */   }
/*     */ 
/*     */   
/*     */   protected final void bindValues(DatabaseStatement stmt, PhoneImagePlayItemListBean entity) {
...
/*     */     }
/* 105 */     stmt.bindLong(9, entity.getRunning_time());
/*     */     
/* 107 */     String file_md5 = entity.getFile_md5();
/* 108 */     if (file_md5 != null) {
/* 109 */       stmt.bindString(10, file_md5);
/*     */     }
/*     */   }
/*     */ 
/*     */   
/*     */   protected final void bindValues(SQLiteStatement stmt, PhoneImagePlayItemListBean entity) {
...
/*     */     }
/* 144 */     stmt.bindLong(9, entity.getRunning_time());
/*     */     
/* 146 */     String file_md5 = entity.getFile_md5();
/* 147 */     if (file_md5 != null) {
/* 148 */       stmt.bindString(10, file_md5);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*     */   public PhoneImagePlayItemListBean readEntity(Cursor cursor, int offset) {
/* 169 */     PhoneImagePlayItemListBean entity = new PhoneImagePlayItemListBean(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)), cursor.getLong(offset + 1), cursor.getLong(offset + 2), cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), cursor.getInt(offset + 5), cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), cursor.getInt(offset + 8), cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
/*     */     
/* 171 */     return entity;
/*     */   }
/*     */ 
/*     */   
/*     */   public void readEntity(Cursor cursor, PhoneImagePlayItemListBean entity, int offset) {
...
/* 184 */     entity.setRunning_time(cursor.getInt(offset + 8));
/* 185 */     entity.setFile_md5(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
/*     */   }
/*     */ 
/*     */   
/*     */   protected final Long updateKeyAfterInsert(PhoneImagePlayItemListBean entity, long rowId) {
/* 190 */     entity.setId(Long.valueOf(rowId));
/* 191 */     return Long.valueOf(rowId);
/*     */   }
/*     */ 
/*     */   
/*     */   public Long getKey(PhoneImagePlayItemListBean entity) {
/* 196 */     if (entity != null) {
...
/*     */ 
/*     */   
/*     */   public boolean hasKey(PhoneImagePlayItemListBean entity) {
...
/*     */ 
/*     */   
/*     */   public List<PhoneImagePlayItemListBean> _queryPhonePlayAreaListBean_ImagePlayItemList(long link_id) {
/* 215 */     synchronized (this) {
/* 216 */       if (this.phonePlayAreaListBean_ImagePlayItemListQuery == null) {
/* 217 */         QueryBuilder<PhoneImagePlayItemListBean> queryBuilder = queryBuilder();
/* 218 */         queryBuilder.where(Properties.Link_id.eq(null), new org.greenrobot.greendao.query.WhereCondition[0]);
/* 219 */         this.phonePlayAreaListBean_ImagePlayItemListQuery = queryBuilder.build();
/*     */       } 
/*     */     } 
/* 222 */     Query<PhoneImagePlayItemListBean> query = this.phonePlayAreaListBean_ImagePlayItemListQuery.forCurrentThread();
...
/* Location:              D:\androidstudio\workspace\TestProjects\reverseAPK\adlibrary-release\classes.jar!\co\\using\adlibrary\dao\PhoneImagePlayItemListBeanDao.class
