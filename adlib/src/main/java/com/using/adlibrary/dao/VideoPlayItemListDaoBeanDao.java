...
/*     */ 
/*     */ 
/*     */ public class VideoPlayItemListDaoBeanDao
/*     */   extends AbstractDao<VideoPlayItemListDaoBean, Long>
/*     */ {
/*     */   public static final String TABLENAME = "VIDEO_PLAY_ITEM_LIST_DAO_BEAN";
/*     */   private Query<VideoPlayItemListDaoBean> playAreaListDaoBean_VideoPlayItemListQuery;
/*     */   
...
/*     */ 
/*     */   
/*     */   public VideoPlayItemListDaoBeanDao(DaoConfig config) {
/*  45 */     super(config);
/*     */   }
/*     */   
/*     */   public VideoPlayItemListDaoBeanDao(DaoConfig config, DaoSession daoSession) {
...
/*  55 */     db.execSQL("CREATE TABLE " + constraint + "\"VIDEO_PLAY_ITEM_LIST_DAO_BEAN\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"ITEM_ID\" INTEGER NOT NULL ,\"LINK_ID\" INTEGER NOT NULL ,\"FILE_NAME\" TEXT,\"PLAY_ITEM_NAME\" TEXT,\"PLAY_ITEM_TYPE\" TEXT,\"RESOLUTION\" TEXT,\"SIZE\" INTEGER NOT NULL ,\"CHECKSUM\" TEXT,\"FILE_MD5\" TEXT);");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  70 */     String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"VIDEO_PLAY_ITEM_LIST_DAO_BEAN\"";
/*  71 */     db.execSQL(sql);
/*     */   }
/*     */ 
/*     */   
/*     */   protected final void bindValues(DatabaseStatement stmt, VideoPlayItemListDaoBean entity) {
...
/*     */     }
/*     */     
/* 111 */     String fileMd5 = entity.getFileMd5();
/* 112 */     if (fileMd5 != null) {
/* 113 */       stmt.bindString(10, fileMd5);
/*     */     }
/*     */   }
/*     */ 
/*     */   
/*     */   protected final void bindValues(SQLiteStatement stmt, VideoPlayItemListDaoBean entity) {
...
/*     */     }
/*     */     
/* 154 */     String fileMd5 = entity.getFileMd5();
/* 155 */     if (fileMd5 != null) {
/* 156 */       stmt.bindString(10, fileMd5);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*     */   public VideoPlayItemListDaoBean readEntity(Cursor cursor, int offset) {
/* 177 */     VideoPlayItemListDaoBean entity = new VideoPlayItemListDaoBean(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)), cursor.getLong(offset + 1), cursor.getLong(offset + 2), cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), cursor.getInt(offset + 7), cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
/*     */     
/* 179 */     return entity;
/*     */   }
/*     */ 
/*     */   
/*     */   public void readEntity(Cursor cursor, VideoPlayItemListDaoBean entity, int offset) {
...
/* 193 */     entity.setFileMd5(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
/*     */   }
/*     */ 
/*     */   
/*     */   protected final Long updateKeyAfterInsert(VideoPlayItemListDaoBean entity, long rowId) {
/* 198 */     entity.setId(Long.valueOf(rowId));
/* 199 */     return Long.valueOf(rowId);
/*     */   }
/*     */ 
/*     */   
/*     */   public Long getKey(VideoPlayItemListDaoBean entity) {
/* 204 */     if (entity != null) {
...
/*     */ 
/*     */   
/*     */   public boolean hasKey(VideoPlayItemListDaoBean entity) {
...
/*     */ 
/*     */   
/*     */   public List<VideoPlayItemListDaoBean> _queryPlayAreaListDaoBean_VideoPlayItemList(long link_id) {
/* 223 */     synchronized (this) {
/* 224 */       if (this.playAreaListDaoBean_VideoPlayItemListQuery == null) {
/* 225 */         QueryBuilder<VideoPlayItemListDaoBean> queryBuilder = queryBuilder();
/* 226 */         queryBuilder.where(Properties.Link_id.eq(null), new org.greenrobot.greendao.query.WhereCondition[0]);
/* 227 */         this.playAreaListDaoBean_VideoPlayItemListQuery = queryBuilder.build();
/*     */       } 
/*     */     } 
/* 230 */     Query<VideoPlayItemListDaoBean> query = this.playAreaListDaoBean_VideoPlayItemListQuery.forCurrentThread();
...
/* Location:              D:\androidstudio\workspace\TestProjects\reverseAPK\adlibrary-release\classes.jar!\co\\using\adlibrary\dao\VideoPlayItemListDaoBeanDao.class
