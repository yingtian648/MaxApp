...
/*     */ 
/*     */ 
/*     */ public class RootListDaoBeanDao
/*     */   extends AbstractDao<RootListDaoBean, Long>
/*     */ {
/*     */   public static final String TABLENAME = "ROOT_LIST_DAO_BEAN";
...
/*     */ 
/*     */   
/*     */   public RootListDaoBeanDao(DaoConfig config) {
/*  42 */     super(config);
/*     */   }
/*     */   
/*     */   public RootListDaoBeanDao(DaoConfig config, DaoSession daoSession) {
...
/*  53 */     db.execSQL("CREATE TABLE " + constraint + "\"ROOT_LIST_DAO_BEAN\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"PLAY_LIST_ID\" INTEGER NOT NULL ,\"PLAY_LIST_NAME\" TEXT,\"PLAY_LIST_TYPE\" TEXT,\"START_TIME\" INTEGER NOT NULL ,\"PLAY_TIME\" INTEGER NOT NULL ,\"FAIL_TIME\" INTEGER NOT NULL ,\"DOWNLOAD_TIME\" INTEGER NOT NULL ,\"SUBTITLE_PLAY_TIME\" TEXT);");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  67 */     String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ROOT_LIST_DAO_BEAN\"";
/*  68 */     db.execSQL(sql);
/*     */   }
/*     */ 
/*     */   
/*     */   protected final void bindValues(DatabaseStatement stmt, RootListDaoBean entity) {
...
/*     */ 
/*     */   
/*     */   protected final void bindValues(SQLiteStatement stmt, RootListDaoBean entity) {
...
/*     */ 
/*     */   
/*     */   protected final void attachEntity(RootListDaoBean entity) {
...
/*     */ 
/*     */   
/*     */   public RootListDaoBean readEntity(Cursor cursor, int offset) {
/* 153 */     RootListDaoBean entity = new RootListDaoBean(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)), cursor.getLong(offset + 1), cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), cursor.getLong(offset + 4), cursor.getLong(offset + 5), cursor.getLong(offset + 6), cursor.getLong(offset + 7), cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
/*     */     
/* 155 */     return entity;
/*     */   }
/*     */ 
/*     */   
/*     */   public void readEntity(Cursor cursor, RootListDaoBean entity, int offset) {
...
/*     */ 
/*     */   
/*     */   protected final Long updateKeyAfterInsert(RootListDaoBean entity, long rowId) {
/* 173 */     entity.setId(Long.valueOf(rowId));
/* 174 */     return Long.valueOf(rowId);
/*     */   }
/*     */ 
/*     */   
/*     */   public Long getKey(RootListDaoBean entity) {
/* 179 */     if (entity != null) {
...
/*     */ 
/*     */   
/*     */   public boolean hasKey(RootListDaoBean entity) {
...
/* Location:              D:\androidstudio\workspace\TestProjects\reverseAPK\adlibrary-release\classes.jar!\co\\using\adlibrary\dao\RootListDaoBeanDao.class
